	...
	'shortcode_carousel' => array(
		'options' => array(
			...
			array(
				...
				'default' => array(false),
				'w' => '50%',
				'hide'=>array('autop_speed')
			),
			array(
				'id' => 'autop_speed',
				'title' => __('AutoPlay Speed',THEME_SLUG),
				'type' => 'text',
				'default' => '5000',
				'rows' => '3',
				'w' => '50%',
							...
							if ('category_' == substr($cat, 0, 9)) {
								...
								switch ($cat) {
									...
									default:
										...
										$current_value5 = substr($current_value, 0, 5);
										if ('fa fa' !== $current_value5 && 'flati' !== $current_value5) {
											$current_value = 'fa fa-' . $current_value;
										}
										$output .= call_user_func_array($cat, array($current_value));
										$skip_options = true;
