...
function staff_metabox_save( $term_id, $tt_id ) {
	...
	if ( isset( $_POST['cws-clinico-dept-procedures'] ) && !empty($_POST['cws-clinico-dept-procedures']) ) {
...
function cws_metabox_scripts_enqueue($a) {
 if( $a == 'widgets.php' || $a == 'post-new.php' || $a == 'post.php' || $a == 'edit-tags.php' || $a == 'term.php') {
	...
	$post_tel_attr = array(
		'telephone' => array(
			'options' => array(
				array(
					'id' => 'telephone',
					'title' => __('Telephone :',THEME_SLUG),
					'type' => 'group',
					'source' => array(
						array(
							'id' => 'typePhone',
							'title' => __('Type telephone',THEME_SLUG),
							'type' => 'select',
							'select' => 'multiple',
							'source' => array('mobile', 'fax', 'home'),
							'w' => '100%'
						),
						array(
							'id' => 'telephone_number',
							'title' => __('Telephone number',THEME_SLUG),
							'type' => 'text',
							'w' => '150px'
						),
